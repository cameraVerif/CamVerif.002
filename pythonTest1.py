...
# # Example usage
# text = "128557700*xp1 + 79146100*yp1 + -74225000*zp1 ==    -11434868107"
# result = replace_single_equals(text)
# print(result)
...
def handleMultipleLevelOfRefinement(triangle):
    ...
    for k in range(0, numberOfProcessCreated):
        fileName = str("tempFiles/finalError/")+str(uniqueIdList[k])+".txt"
        ...
        for i in range(0,len(dataFromProcessing)):
            ...
            for j in range(0, len(list_of_lists)):
                ...
                for l in range(0,len(currSmallRegionToBack)):
                    ...
                    currStringcons = currSmallRegionToBack[l]
                    print("currStringcons = ", currStringcons)
                    currStringcons = currStringcons.replace("\n","")
                    currStringcons = currStringcons.replace(" ","")
                    print(currStringcons)
                    currRegionCons = And(currRegionCons, simplify(eval(currStringcons)))
            ...
            for j in range(0, len(regionConsZ3ToBackTrack)):
                ...
                # print(intersectionRegionConZ3_2)
                
                currentNodeString = "A_0_0_0_0_0_0_0_0_0_0_0_0_2_0_2_1_1_0_0"
                pathLengthToAncestor = 1
...
numberOfProcessCreated = 1
uniqueIdList = ['A_0_0_0_0_0_0_0_0_0_0_0_0_2_0_2_1_1_0_0'] 
triangle = 1000
handleMultipleLevelOfRefinement(triangle)
