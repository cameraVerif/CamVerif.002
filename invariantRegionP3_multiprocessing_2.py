...
def computeInvRegions(currGroupName, currGroupRegionCons, dnnOutput, uniqueId, queue, fromSplitRegion=0):
    ...
    del(s2)
    del(triaglesInvRegions)
    del(regionsToReturn)
    del(regionsToReturnStringList)
    del(currInvCons)
    del(currInvConsStringList)
...
if __name__ == "__main__":
    ...
    for k in range(0, total_tasks):
        ...
        process = Process(target=computeInvRegions, args=(currGroupName, currGroupRegionCons, 1, uniqueId,  queue))
