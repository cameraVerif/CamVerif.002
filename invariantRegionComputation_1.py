...
def getInvariantRegion(currTriangle, posXp, posYp, posZp, m):
...
def computeInvRegions(currGroupName, currGroupRegionCons, fromSplitRegion=0):
    ...
    while(s2.check() ==sat):
        ...
        for i in range(0, scene.numOfTriangles):
            regionExist, currTriangleInvRegion = getInvariantRegion(i, posXp, posYp, posZp, m)
