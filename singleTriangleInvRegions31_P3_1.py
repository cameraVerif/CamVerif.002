...
def planeEdgeIntersectionUpdated(plane,insideVertex, outsideVertex,m, newCode = 0): 
    ...
    if(result ==sat):
        ...
        # print("Computing pixel values of intersecting point\n-----------")
        ...
        # print("not intersecting with the plane")
        # print("Returning planeEdgeIntersection")
...
def computeTriangleInvariantRegions2(currTriangle,currGroupName, currGroupRegionCons):
    ...
    # if(s2.check() ==sat):
        # print("\n\n\n==***********************************==========================\n\n")
        # print("Number of Inv Regions = ",numberOfInvRegions)
        ...
        # print("currImageColours = ",currImageColours)
        ...
        if(not any(outcodeP0)):
            ...
            for currVert in range(0,3):        
                ...
                # print("currPixelValue using python ==> ", vertexPixelValue) 
            ...
            for currPlane in [5,0,1,2,3]:
                ...
                for currVert in tr_vertices_set:
                    if(tr_vertex_outcodes[currVert][currPlane] == 1):
                        # print(currVert, " vertex outside the plane ", currPlane)
        ...
        for l in itertools.product(*combinedDataToPPL):
            ...
            if(str(currImageSetConString).replace(" ","") == "-1==0" or str(currImageSetConString).replace(" ","") == "0==-1"):
                # print("Continue with the next point, criti")
                # print("Current Triangle ", currTriangle)
                # sleep(1)
                continue
        ...
        if findARegion == 0:
            ...
            if(scheck3.check() != sat or foundR == 0 ):                
                ...
                # oldInvComputation1.findInvRegion(posXp, posYp, posZp, currTriangle,m)
                ...
                eFile.write("Numerical difficulty in finding the region for the triangle "+str(currTriangle)+"\n")
            ...
            if numberOfInvRegions > 100:
                # print("Current triangle has more than 100 invariant regions, may be neumerical pblm, skipping this triangle"+str(currTriangle))
                criticalFile=open("ErrorLog.txt","a")
                criticalFile.write("\nCurrent triangle has more than 250 invariant regions, may be neumerical issyes, skipping this triangle")
                criticalFile.write("Current Triangle = "+str(currTriangle))
                criticalFile.write("currGroupRegionCons = "+str(currGroupRegionCons))
        ...
        for intVert in range(0,numberOfIntersectingEdges):
            # print("\nComputing depth of the intersecting point ", intVert)
            ...
            # mindepth = gurobiGetDepths4.getDepthIntervals4(currImageSetConString,dataToComputeDepth[numberOfFullyInsideVertices+intVert],\
            #                                                         currGroupRegionCons,edgeVertexIndices, currTriangleVertices)
...
def computePixelIntervalsOfIntersectingTriangles(intersectingTriangles, currGroupName, currGroupRegionCons, fromSplitRegion=0):
    globalIntervalImage.clear()  
    dictionaryOfTriangleIntervalImages.clear()
    
    

    # print("\n\n~~~~reached intersecting triangle interval image computation")
    # print(currGroupRegionCons)
    # print(mProj)

    numberOfreg = [0]*len(intersectingTriangles)
    ...
    for i in intersectingTriangles:     
    # for i in range(0 , environment.numOfTriangles): 
    ...
    # for i in [157]:   
        ...
        computeTriangleInvariantRegions2(i,currGroupName, currGroupRegionCons)
        
        # if(numberOfreg[i] > 0):
        #     updateGlobalIntervalImage2(i,numberOfreg[i])
        #     print("dictionaryOfTriangleIntervalImages ", dictionaryOfTriangleIntervalImages)
    ...
    return dictionaryOfTriangleIntervalImages
    # exit()
